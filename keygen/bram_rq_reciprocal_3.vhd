...
entity bram_rq_reciprocal_3 is
	generic(
	...
	port(
		...
		---
		bram_f_data_in_a  : in  std_logic_vector(bram_data_width - 1 downto 0);
		bram_g_data_in_a  : in  std_logic_vector(bram_data_width - 1 downto 0);
		bram_v_data_in_a  : in  std_logic_vector(bram_data_width - 1 downto 0);
		bram_r_data_in_a  : in  std_logic_vector(bram_data_width - 1 downto 0);
		bram_f_write_a    : in  std_logic;
		bram_g_write_a    : in  std_logic;
		bram_v_write_a    : in  std_logic;
		bram_r_write_a    : in  std_logic;
		...
		bram_f_data_out_b : out std_logic_vector(bram_data_width - 1 downto 0);
		bram_g_data_out_b : out std_logic_vector(bram_data_width - 1 downto 0);
		bram_v_data_out_b : out std_logic_vector(bram_data_width - 1 downto 0);
		bram_r_data_out_b : out std_logic_vector(bram_data_width - 1 downto 0)
	);
end entity bram_rq_reciprocal_3;

architecture RTL of bram_rq_reciprocal_3 is
...
begin
	...
	bram_fg_one_data_in_a <= bram_f_data_in_a when swap_mask_s = '0' else bram_g_data_in_a;
	bram_fg_two_data_in_a <= bram_g_data_in_a when swap_mask_s = '0' else bram_f_data_in_a;
	bram_vr_one_data_in_a <= bram_v_data_in_a when swap_mask_s = '0' else bram_r_data_in_a;
	bram_vr_two_data_in_a <= bram_r_data_in_a when swap_mask_s = '0' else bram_v_data_in_a;

	bram_fg_one_write_a <= bram_f_write_a when swap_mask_s = '0' else bram_g_write_a;
	bram_fg_two_write_a <= bram_g_write_a when swap_mask_s = '0' else bram_f_write_a;
	bram_vr_one_write_a <= bram_v_write_a when swap_mask_s = '0' else bram_r_write_a;
	bram_vr_two_write_a <= bram_r_write_a when swap_mask_s = '0' else bram_v_write_a;
	...
	block_ram_inst_fg_one : entity work.block_ram
		...
		port map(
			...
			write_a    => bram_fg_one_write_a,
			data_in_a  => bram_fg_one_data_in_a,
			...
			data_out_b => bram_fg_one_data_out_b
		);
	...
	block_ram_inst_fg_two : entity work.block_ram
		...
		port map(
			...
			write_a    => bram_fg_two_write_a,
			data_in_a  => bram_fg_two_data_in_a,
			...
			data_out_b => bram_fg_two_data_out_b
		);
	...
	block_ram_inst_vr_one : entity work.block_ram
		...
		port map(
			...
			write_a    => bram_vr_one_write_a,
			data_in_a  => bram_vr_one_data_in_a,
			...
			data_out_b => bram_vr_one_data_out_b
		);
	...
	block_ram_inst_vr_two : entity work.block_ram
		...
		port map(
			...
			write_a    => bram_vr_two_write_a,
			data_in_a  => bram_vr_two_data_in_a,
			...
			data_out_b => bram_vr_two_data_out_b
		);
